...
// - sortBy is more concise for simple cases`}
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      View the implementation of <code class="text-sm">sort</code> on GitHub to see how it works internally.
    </p>

    <a
      href="https://github.com/superlucky84/fp-pack/blob/main/src/implement/array/sort.ts"
      target="_blank"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
      ...
      >
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          Transform items before sorting
        </p>
      </div>
    </div>
