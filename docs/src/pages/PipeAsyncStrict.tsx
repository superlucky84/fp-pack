  ...
  (n) => n * 2
    ...
    <div class="border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20 p-4 mb-6 rounded-r">
      <p class="text-sm md:text-base text-yellow-800 dark:text-yellow-200 leading-relaxed">
        ...
        <br />
        <br />
        You are currently viewing <strong>pipeAsyncStrict</strong>. Use this function when type
        safety is more important than inference flexibility, especially in critical async code
        paths. If you find the type-checking too restrictive for your use case, consider using{' '}
        <a
