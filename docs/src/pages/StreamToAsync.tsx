...
// [[1, 2], [3, 4]]`}
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mt-6 mb-6">
      Tip: <code class="text-sm">T</code> is the element type, not the final array. After
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      View the implementation of <code class="text-sm">toAsync</code> on GitHub to see how it works internally.
    </p>

    <a
      href="https://github.com/superlucky84/fp-pack/blob/main/src/stream/toAsync.ts"
      target="_blank"
