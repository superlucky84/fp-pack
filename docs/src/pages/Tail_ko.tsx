...
export const Tail_ko = () => (
  <div class="prose prose-lg dark:prose-invert max-w-none">
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      ...
      은 첫 요소를 제외한 새 배열을 반환합니다. 헤더 제거, 목록 순차 처리,
      <code class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded">head</code>와의 조합에 유용합니다.
    </p>
...
// rest: [20, 30]`}
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      <code class="text-sm">tail</code>의 내부 구현을 GitHub에서 확인하세요.
    </p>

    <a
      href="https://github.com/superlucky84/fp-pack/blob/main/src/implement/array/tail.ts"
      target="_blank"
