...
export const ToUpper_ko = () => (
  <div class="prose prose-lg dark:prose-invert max-w-none">
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      ...
      는 입력 문자열을 대문자로 변환합니다. 정규화, 포맷팅, 대소문자 무시 비교 등에 유용합니다.
    </p>
...
// ['DRAFT', 'PUBLISHED', 'ARCHIVED']`}
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      <code class="text-sm">toUpper</code>의 내부 구현을 GitHub에서 확인하세요.
    </p>

    <a
      href="https://github.com/superlucky84/fp-pack/blob/main/src/implement/string/toUpper.ts"
      target="_blank"
